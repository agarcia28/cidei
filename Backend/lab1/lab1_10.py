...
class Bussiness(Contact):
	...
	# Metodo para mostrar todos los empleados en la lista
	...
	# Representael string de una clase, que a su vez es un objeto
	def __str__(self):
		return "La tarjeta de negocios para empleado: %s - %s - %s" % (self._name, self._email, self._phone)